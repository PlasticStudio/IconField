...
- `$iconFolder` (optional) defines the directory where your icons can be found. If your project has a `public` directory, you'll need to make sure the path to this folder is exposed. Defaults to `_resources/app/client/assets/icons` (you can override this default in your project's own config file).
